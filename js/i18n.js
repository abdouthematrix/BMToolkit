    ...
    constructor() {
        ...
        this.translations = {
            en: {
                ...
                'mortgage-desc': 'CBE housing initiatives calculators',
                'tab-cbe-8': 'CBE 8% Initiative',
                'tab-cbe-12': 'CBE 12% Initiative',
                'tab-max-income': 'Max Loan by Income',
                'tab-fixed': 'Fixed Installment',
                'tab-escalating': 'Escalating Installment',
                'initiative-details': 'Initiative Details',
                'rate-annual': 'Rate (Annual)',
                'dbr-limit': 'DBR Limit',
                'max-tenor-years': 'Maximum Tenor (Years)',
                'escalating-policy': 'Escalating Policy',
                'escalating-policy-8': '+5% annually across full tenor',
                'escalating-policy-12': '+7% annually for first 10 years, then fixed',
                'max-income-individual': 'Max Individual Income',
                'max-income-family': 'Max Family Income',
                'unit-range': 'Unit Price Range',
                'income-type': 'Income Type',
                'individual': 'Individual',
                'family': 'Family',
                'unit-price': 'Unit Price (EGP)',
                'loan-amount-auto': 'Loan Amount (auto by LTV, editable)',
                'tenor-years': 'Tenor (Years)',
                'dbr-capacity': 'DBR Capacity',
                'obligations-used': 'Obligations Used',
                'available-installment': 'Available Installment',
                'max-fixed-loan': 'Max Fixed Loan',
                'max-escalating-loan': 'Max Escalating Loan',
                'fixed-installment': 'Fixed Installment',
                'escalating-installment': 'Escalating Installment',
                'year-1-installment': 'Year 1 Installment',
                'admin-fee-amount': 'Admin Fee Amount',
                'eligibility-unit-range': 'Unit price is outside initiative range.',
                'eligibility-income-max': 'Income exceeds initiative maximum.',
                'eligibility-ltv-cap': 'Loan amount capped by LTV limit.',
                'eligibility-loan-cap': 'Loan amount capped by initiative max loan limit.',
                'tier-1': 'Tier 1',
                'tier-2': 'Tier 2',
                'detected-tier': 'Detected Tier',
                'tenor-capped-warning': 'Tenor capped to initiative maximum ({max} years).',
                'year': 'Year',
            ...
            ar: {
                ...
                'mortgage-desc': 'حاسبات مبادرات البنك المركزي للتمويل العقاري',
                'tab-cbe-8': 'مبادرة البنك المركزي 8%',
                'tab-cbe-12': 'مبادرة البنك المركزي 12%',
                'tab-max-income': 'أقصى قرض حسب الدخل',
                'tab-fixed': 'قسط ثابت',
                'tab-escalating': 'قسط متزايد',
                'initiative-details': 'تفاصيل المبادرة',
                'rate-annual': 'العائد السنوي',
                'dbr-limit': 'حد عبء الدين',
                'max-tenor-years': 'الحد الأقصى للمدة (سنة)',
                'escalating-policy': 'سياسة الزيادة',
                'escalating-policy-8': 'زيادة 5% سنويًا طوال مدة القرض',
                'escalating-policy-12': 'زيادة 7% سنويًا لأول 10 سنوات ثم يثبت القسط',
                'max-income-individual': 'الحد الأقصى للدخل الفردي',
                'max-income-family': 'الحد الأقصى لدخل الأسرة',
                'unit-range': 'نطاق سعر الوحدة',
                'income-type': 'نوع الدخل',
                'individual': 'فردي',
                'family': 'أسرة',
                'unit-price': 'سعر الوحدة (جنيه)',
                'loan-amount-auto': 'قيمة القرض (تلقائي حسب نسبة التمويل وقابل للتعديل)',
                'tenor-years': 'المدة (بالسنوات)',
                'dbr-capacity': 'القدرة التمويلية حسب DBR',
                'obligations-used': 'الالتزامات المستخدمة',
                'available-installment': 'المتاح للقسط',
                'max-fixed-loan': 'أقصى قرض ثابت',
                'max-escalating-loan': 'أقصى قرض متزايد',
                'fixed-installment': 'القسط الثابت',
                'escalating-installment': 'القسط المتزايد',
                'year-1-installment': 'قسط السنة الأولى',
                'admin-fee-amount': 'قيمة المصاريف الإدارية',
                'eligibility-unit-range': 'سعر الوحدة خارج نطاق المبادرة.',
                'eligibility-income-max': 'الدخل يتجاوز الحد الأقصى للمبادرة.',
                'eligibility-ltv-cap': 'القرض تم تقييده بحد نسبة التمويل.',
                'eligibility-loan-cap': 'القرض تم تقييده بحد أقصى قيمة القرض.',
                'tier-1': 'الشريحة الأولى',
                'tier-2': 'الشريحة الثانية',
                'detected-tier': 'الشريحة المكتشفة',
