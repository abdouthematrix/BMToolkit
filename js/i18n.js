    ...
    constructor() {
        ...
        this.translations = {
            en: {
                ...
                'cash-loans-title': 'Cash Loans',
                'cash-loans-desc': 'Access secured and unsecured cash loan calculators',
                'mortgage-title': 'Mortgage',
                'mortgage-desc': 'CBE mortgage initiatives with fixed and escalating installments',
                'mortgage-initiative-8': '8% Initiative (Middle Income)',
                'mortgage-initiative-12': '12% Initiative (Middle Income)',
                'fixed-installment': 'Fixed Installment',
                'escalating-installment': 'Escalating Installment',
                ...
                'td-90-loan-title': '90% Loan Against TD',
                'td-90-loan-desc': 'Get immediate cash while keeping your TD principal protected.',
                'td-90-summary-title': 'Highest Loan — Immediate Cash',
                'td-90-summary-desc': 'Use up to 90% of the TD value as a secured loan and offset the installment with TD income.',
                'td-90-cash-now': 'Cash Now',
                'td-90-extra-monthly': 'Monthly payment above TD interest',
                'td-90-effective-payments': 'Effective payments',
                'td-90-save': 'Save',
                'td-90-protected-principal': 'Protected TD Principal',
                'td-reinvest-loan-title': 'Loan Against TD + Reinvest',
                'td-reinvest-loan-desc': 'Use the configured reinvest scenario percentage, deduct fees, and reinvest the net loan into another TD.',
                'td-reinvest-summary-title': 'Loan Reinvested into TD',
                'td-reinvest-summary-desc': 'Use the configured 4th scenario loan percentage, reinvest the net amount after fees, and compare combined TD income with the loan installment.',
                ...
                'total-return-percent': 'Total Return %',
                ...
                'tab-td-90-loan': '90% Against TD',
                'tab-td-reinvest-loan': 'Reinvest TD',
            ...
            ar: {
                ...
                'unsecured-loans-title': 'القروض غير المضمونة',
                ...
                'loans-title': 'القروض',
                'loans-desc': 'جميع منتجات وحاسبات القروض في مكان واحد',

                'cash-loans-title': 'القروض النقدية',
                'cash-loans-desc': 'الوصول إلى حاسبات القروض النقدية المضمونة وغير المضمونة',
                'mortgage-title': 'التمويل العقاري',
                'mortgage-desc': 'مبادرات التمويل العقاري من البنك المركزي بأقساط ثابتة ومتزايدة',
                'mortgage-initiative-8': 'مبادرة 8% (متوسطي الدخل)',
                'mortgage-initiative-12': 'مبادرة 12% (متوسطي الدخل)',
                'fixed-installment': 'قسط ثابت',
                'escalating-installment': 'قسط متزايد',
                ...
                'td-90-loan-title': 'قرض 90% بضمان الوديعة',
                'td-90-loan-desc': 'احصل على كاش فوري مع الحفاظ على أصل الوديعة.',
                'td-90-summary-title': 'أعلى قرض — كاش فوري',
                'td-90-summary-desc': 'استخدم حتى 90% من قيمة الوديعة كقرض مضمون وعوض القسط من عائد الوديعة.',
                'td-90-cash-now': 'كاش فوراً',
                'td-90-extra-monthly': 'قسط شهري زيادة فوق فائدة الوديعة',
                'td-90-effective-payments': 'مدفوعات فعلية',
                'td-90-save': 'وفر',
                'td-90-protected-principal': 'أصل الوديعة المحفوظ',
                'td-reinvest-loan-title': 'قرض بضمان الوديعة مع إعادة الاستثمار',
                'td-reinvest-loan-desc': 'استخدم نسبة سيناريو إعادة الاستثمار المعرّفة، اخصم المصاريف، وأعد استثمار صافي القرض في وديعة أخرى.',
                'td-reinvest-summary-title': 'إعادة استثمار القرض في وديعة',
                'td-reinvest-summary-desc': 'استخدم نسبة القرض المعرّفة للسيناريو الرابع وأعد استثمار صافي المبلغ بعد المصاريف لمقارنة عائد الودائع المجمع مع القسط.',
                ...
                'total-return-percent': 'نسبة إجمالي العائد',
                ...
                'tab-td-90-loan': 'قرض 90% بضمان الوديعة',
                'tab-td-reinvest-loan': 'إعادة الاستثمار',
